<?php
/**
*   German formal language file for the Custom Profile plugin, adressing the user as (Sie)
*
...
'hlp_fld_chkbox_default'	=> 'Geben Sie "1" für aktiviert oder "0" für deaktiviert ein.',
...
'hlp_visible'				=> 'Diese Feld ist in Ihrem Profil sichtbar',
'hlp_invisible'				=> 'Diese Feld ist in Ihrem Profil NICHT sichtbar',
...
'help'  => array(
    'list'					=> 'Erstellen, bearbeiten und sortieren Sie hier benutzerdefinierte Profil-Felder',
    'searchusers'			=> '<ul><li>Geben Sie die Werte ein, die für die Benutzer-Suche verwendet werden sollen.</li><li>Aktivieren Sie das Kontrollkästchen unter "Leer?" Wenn das Feld leer sein sollte, andernfalls werden alle leeren Felder ignoriert.</li></ul>',
    'lists'					=> '<ul><li>Erstellen und bearbeiten Sie Benutzer-Listen.</li><li>Kopieren Sie den Link der Listen-Name/ID für die Platzierung in Menüs und anderen Inhalten.</li></ul>',
    'editform'				=> '<ul><li>Erstellen Sie hier neue benutzerdefinierte Profil-Felder.</li><li>Die Sortierung gibt an, wo das Feld im Verhältnis zu anderen Feldern in den Listen erscheint.</li><li>Die Sortierung der Felder kann später jederzeit geändert werden.</li></ul>',
    'editlist'				=> '<ul><li>Definieren oder ändern Sie die Ansicht der Benutzer-Listen.</li><li>Markieren Sie die Felder, die aufgenommen werden sollen.</li><li>Ändern Sie die Reihenfolge oder Spaltenüberschriften.</li></ul>',
    'resetpermform'			=> 'Setzen Sie alle Feld-Berechtigungen auf ihre Standardwerte zurück.',
),
